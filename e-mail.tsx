      ...
      <Html>
        ...
        <Body className="bg-gray-100 font-work-sans">
          <Container
            ...
            className="bg-white p-14 mt-20 rounded-lg border-gray-400/40 border border-solid"
          >
            <Section>
              ...
              <Link
                className="text-small-regular text-esmerald-500 text-center w-full mx-auto block"
